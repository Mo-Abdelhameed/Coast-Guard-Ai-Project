...
public class State implements Cloneable, Comparable{
    ...
    // to estimate the cost of closest ship and depending on h2 boolean we consider the number of people or we do not
    ...
    // to get the manhattan distance to the nearest station
